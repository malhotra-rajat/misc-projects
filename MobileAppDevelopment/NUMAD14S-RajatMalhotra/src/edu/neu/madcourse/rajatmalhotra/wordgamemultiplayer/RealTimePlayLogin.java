...
public class RealTimePlayLogin extends Activity {
...
private class loginAsyncTask extends AsyncTask<String, Integer, Integer> {
		...
		// [... Report results via UI update, Dialog, or notification ...]
			if (result == 0)
			{
				Intent intent = new Intent(RealTimePlayLogin.this, RealTimePlayTP.class);
				startActivity(intent);
				/*Intent intent = new Intent(RealTimePlayLogin.this, WordGameTP.class);
				startActivity(intent);*/
			}
			if (result == 1)
			{
