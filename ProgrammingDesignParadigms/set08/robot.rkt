...
; -- "north"    interp: robot to be moved in north direction
; -- "east"     interp: robot to be moved in east direction
; -- "south"    interp: robot to be moved in south direction
; -- "west"     interp: robot to be moved in west direction
