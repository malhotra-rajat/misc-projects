...
namespace CreatingA2DSprite
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        AudioEngine audioEngine; // for audio
        WaveBank waveBank;
        SoundBank soundBank;
        Cue sbacksound;         // Start Screen Sound
        Cue gbacksound;          // Game Play Sound  
        ...
        protected override void Initialize()//to initialise buttons,screen size,Audio
        {
            ...
            sbacksound = soundBank.GetCue("Start");
            gbacksound = soundBank.GetCue("Gameplay_music");
