...
<body>
    ...
    <div class="newStyle2" style="margin-left: 0px">
        ...
        <div style="border: thin ridge #3737FF; float:left; width: 990px; height: 322px; ; top: 0px;">
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                   ...
                   ="server" Interval="50" ontick="Timer1_Tick">
                    </asp:Timer>
                    <asp:TextBox ID="txtMsgBox" runat="server" Height="277px" Width="986px" 
                        TextMode="MultiLine" EnableTheming="True" ForeColor="Black" 
        ...
        <div style="border: thin ridge #3737FF; float:left; margin-right: 7px;" 
                class="style1">
