...
<head runat="server">
    <title>ChatBug : Edit Your Account</title>
    <script language='javascript'>
    function changes()
    {
        String abcd="changes saved";
        alert(abcd);
    }
    </script>
        <style type="text/css">
...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:ImageButton ID="btnSaveChanges" runat="server" Height="40px" 
            ...
            onclick="btnSaveChanges_Click" ValidationGroup="first" onclientclick=changes()
            PostBackUrl="~/User/AccountInfo.aspx" />
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
