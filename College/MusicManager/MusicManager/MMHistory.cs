    ...
    {        
        ...
        partial class MusicDataTable
        {
            ...
            public ArrayList GetGenreList()
            {
                ...
                {
                    generList.Insert(0, string.Format("All Genre({0})",generList.Count));
                    return generList;
                }
                return null;
            }
            public ArrayList GetArtistList()
            {
                ...
                if (strList.Count > 0)
                {
                    strList.Insert(0, string.Format("All Artist({0})", strList.Count));
                    return strList;
                }
                return null;
            }
            ...
            public ArrayList GetAlbumList()
            {
                ...
                if (strList.Count > 0)
                {
                    strList.Insert(0, string.Format("All Album({0})", strList.Count));
                    return strList;
                }
                return null;
            }
